...
import com.diegomunhoz.controlepedidosdm.services.validation.ClienteInsert;
...
public class ClienteNewDTO implements Serializable {
	...
	@NotEmpty(message="Preenchimento da senha obrigatório")
	private String senha;
	
	@NotEmpty(message="Preenchimento do logadouro obrigatório")
