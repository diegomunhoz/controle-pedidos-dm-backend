...
import com.diegomunhoz.controlepedidosdm.domain.Pagamento;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cidade c4 = new Cidade(null, "Barueri", est2);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "teste@teste.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Diego Munhoz", "admin@admin.com", "31086732898", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("33263133","981164359"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jaradim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Alameda Grajau", "128", "Apto 1305", "Alphaville", "06454050", cli2, c4);
